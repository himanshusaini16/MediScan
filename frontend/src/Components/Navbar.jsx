...
const Navbar = () => {
  ...
  return (
    <div className='flex item-center justify-between text-sm py-4 mb-5 border-b border-b-grey-400'>
      <img onClick={() => navigate('/')} className='w-44 h-10 cursor-pointer' src='/logo.png' alt='' />
      <ul className='hidden md:flex items-start gap-5 font-medium'>
        ...
        <NavLink to='/disease-list'>
          <li className='py-1'>DISEASE LIST</li>
          <hr className='border-none outline-none h-0.5 bg-primary w-3/5 m-auto hidden' />
        </NavLink>
        <NavLink to='/doctors'>
  ...
  <div className="relative group">
    ...
    >
      <i onClick={()=>navigate('/message')} className="fas fa-comment-dots text-xl text-blue-600  mr-4"></i>
    </button>
  </div>
)}
            ...
            <div className="flex items-center gap-2 cursor-pointer group relative">
              ...
              <div className="absolute top-0 right-0 pt-14 rounded-lg text-base font-medium text-gray-600 z-20 hidden group-hover:block">
                <div className="min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4">
                  ...
                  <p onClick={() => navigate('/prediction-history')} className="hover:text-black cursor-pointer">
