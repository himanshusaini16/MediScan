...
const History = () => {
  ...
  const formattedDate1 = date1.toLocaleDateString("en-IN", {day:"numeric",
    month: "long",
    year: "numeric",
  });
  ...
  return (
    <div className="w-full max-w-6xl m-5">
      <p className="mb-3 text-lg font-semibold text-center text-gray-900">PREDICTION HISTORY</p>
...
<div className="w-1/2">
      ...
      onChange={(e) => { if(e.target.value === ''){
        setPredictionData([])
      }else{historyData(e.target.value);} setDisease(e.target.value)}}
      ...
      <div className="bg-white border rounded text-sm max-h-[80vh] min-h-[60vh] overflow-y-scroll">
        ...
        {prediction.reverse().map((item, index) => (
          ...
          >
            ...
            <p>{item.date ? formattedDate1 : formattedDate}</p>
