        ...
        <div className="w-full sm:w-3/4 flex flex-col justify-between sm:pl-4">
          {!selectedPatientId ? (
            ...
            <>
              ...
              <form
  className="flex flex-col sm:flex-row w-full gap-2 mt-3"
...
>
  <div className="flex items-center gap-2 w-full">
    ...
    <label
      htmlFor="file-input"
      className="flex items-center justify-center p-2 rounded-lg bg-gray-200 hover:bg-gray-300 cursor-pointer"
    >
      <span title="Gallery">
        <img
