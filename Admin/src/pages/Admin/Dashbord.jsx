    ...
    dashData && (
      <div className="m-5">
        <div className="flex flex-wrap gap-3">
          ...
          <div onClick={()=>navigate('/all-appiontements')} className="flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all">
            <img className="w-14 " src={assets.appointments_icon}></img>
            <div>
              <p className="text-xl font-semibold text-gray-600">
                {dashData.appointments}
              </p>
              <p  className="text-gray-400">Appiontements</p>
            </div>
          </div>
        ...
        <div className="bg-white ">
          <div className="flex items-center gap-2.5 px-4 py-4 mt-10 rounded-t border ">
            <img className="" src={assets.list_icon}></img>
